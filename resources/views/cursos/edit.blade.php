...
@section('content') 
    ...
    <h2 class="text-center mb-3">Editar Curso: {{$curso->nombre}} </h2>       
    <div  class="mt-5">
        <div class="cold-md-8">
            <form method="POST"  action={{route("cursos.update", ['curso'=>$curso->id])}} enctype="multipart/form-data" novalidate>
            @csrf              
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    id="nombre" placeholder="Nombre Curso" value="{{$curso->nombre}}">
                    @error('nombre')
                        ...
                        <div class="form-group mt-3 "   >
                            ...
                            <input id="imagen" type="file" class="form-control @error('contenido') is-invalid @enderror" name="imagen" >
                                ...
                                <div class="mt-4">
                                  ...
                                  <p>Imagen Actual</p>
                                  <img src="/cursos/storage/app/public/{{$curso->imagen}}" style="width: 300px">
